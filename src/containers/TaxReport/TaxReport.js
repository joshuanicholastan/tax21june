...
//                 <Typography align='center' variant = 'overline' component = 'h1' display='block'>
//                     Company Name
//                 </Typography>
//                 <Typography align='center' variant = 'overline' component = 'h2' display='block'>
//                     UEN No. 2018xxxxx
//                 </Typography>
//                 <Typography align='center' variant = 'overline' component = 'h3' display='block'>
//                     Singapore Coporate Tax Computation
//                 </Typography>
//                 <Typography align='center' variant = 'overline' component = 'h4' display='block'>
//                     Year of Assessment {this.props.taxInfo.YA.value}
//                 </Typography>
//                 <Typography align='center' variant = 'overline' component = 'h5' display='block' gutterBottom>
//                     Basis Period: 1 Janurary {this.props.taxInfo.YA.value - 1} to 31 December {this.props.taxInfo.YA.value - 1}
//                 </Typography>
//                 <Table className={classes.table}>
//                     <TableHead maxWidth = "10%">
//                         <TableCell maxWidth = "60%"></TableCell>
//                         <TableCell minWidth = "10%" maxWidth = "10%" align = "right">SGD $</TableCell>
//                         <TableCell minWidth = "10%" maxWidth = "10%" align = "right">SGD $</TableCell>
//                     </TableHead>
//                     <TableBody>
//                         <TableRow> 
//                             <TableCell maxWidth = "40%">Net profit before tax per accounts</TableCell>
//                             <TableCell minWidth = "50%" maxWidth = "50%" align = "right"></TableCell>
//                             <TableCell minWidth = "10%" maxWidth = "10%" align = "right">{this.props.taxOutput.NPBT.value}</TableCell>
//                         </TableRow>
//                         <TableRow> 
//                             <TableCell minWidth = "10%" maxWidth = "10%"> .</TableCell>
//                             <TableCell minWidth = "40%" maxWidth = "40%" align = "left">Add back: non-deductable expenses</TableCell>
//                             <TableCell minWidth = "50%" maxWidth = "50%"> .</TableCell>
//                         </TableRow>
...
// export default connect(mapStateToProps)(withStyles(stylesMUI)(TaxReport));
