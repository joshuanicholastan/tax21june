...
//Actions
import {
    newTaxInfo, cleanTaxObj, cleanOpObj, submitInfo
} from '../../actions'
...
class TaxCalculator extends Component {
    ...
    handleSubmit = () => {
        ...
        //alert(this.props.taxOutput.NPBT.value);
        // for (var key in this.props.taxInfo) {
        //         console.log(JSON.stringify(this.props.taxInfo[key]) + ",");
        // }
       // alert("Net Profit: " + this.props.taxOutput.NPBT.value);
       ...
       // alert("OP1  >> " + this.props.taxOutput.OP_1.value);
        ...
        //alert("OP2  >> " + this.props.taxOutput.OP_2.value);
        this.props.taxOutput.CYCA.value = parseFloat(this.props.taxInfo.CA.value) + parseFloat(this.props.taxInfo.EA.value);

        this.props.taxOutput.OP_3.value = this.props.taxOutput.OP_2.value - this.props.taxOutput.CYCA.value;
       // alert("OP3  >> " + this.props.taxOutput.OP_3.value);
        ...
        //alert(this.props.taxOutput.TAX17.value);
        //for startups i think i forgot what we did last time
...
export default connect(mapStateToProps, {
    newTaxInfo, cleanTaxObj, cleanOpObj, submitInfo, cleanTaxObj
